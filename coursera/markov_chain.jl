...
axislegend(ax)
record(f, joinpath(".", "parallel_met.gif"); framerate=5) do frame
    for i in 1:99
...
axislegend(ax)
record(f, joinpath(".", "parallel_gibbs.gif"); framerate=5) do frame
    for i in 1:199
...
axislegend(ax)
record(f, joinpath(".", "hmc_anim.gif"); framerate=5) do frame
    for i in 1:100
